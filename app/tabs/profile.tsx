...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: Typography.sm, color: Colors.accent, marginTop: 3 },
  ...
  photoInitial: { fontSize: 40, fontWeight: Typography.semibold, color: Colors.ice },
  ...
  photoAddText: { color: Colors.white, fontSize: 18, fontWeight: Typography.semibold },
  ...
  videoBadgeText: { fontSize: 7, color: Colors.accent, fontWeight: Typography.medium },
  photoHint: { fontSize: 10, color: Colors.ice3, marginTop: Spacing.sm },
  ...
  safetyTitle: { fontSize: Typography.base, fontWeight: Typography.medium, color: Colors.ice },
  safetySub: { fontSize: 10, color: Colors.ice3, marginTop: 2 },
  ...
  membershipTitle: { fontSize: Typography.md, fontWeight: Typography.semibold, color: Colors.ice },
});
