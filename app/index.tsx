  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.chipsRow}>
        ...
        >
          <Text style={[styles.chipText, filters.members_plus && styles.chipTextActive, { fontFamily: Typography.brandMed }]}>HUNT Black</Text>
        </TouchableOpacity>
      </View>
        ...
        ListEmptyComponent={
          !isLoading ? (
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyHint}>Try expanding your filters</Text>
            </View>
          ) : null
        }
      />
...
const styles = StyleSheet.create({
  ...
  logo: { fontFamily: Typography.brand, fontSize: 17, letterSpacing: Typography.logo, color: Colors.ice },
  ...
  chipText: { fontFamily: Typography.medium, fontSize: 10, color: Colors.ice3 },
  chipTextActive: { color: Colors.accent },
  grid: { padding: 2, gap: 2 },
  row: { gap: 2 },
  empty: { alignItems: 'center', paddingTop: 80, gap: 8 },
  emptyText: { fontFamily: Typography.medium, fontSize: 16, color: Colors.ice2 },
